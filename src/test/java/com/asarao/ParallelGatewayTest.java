...
public class ParallelGatewayTest {
    ...
    public void deploy() {
        ...
        String processResourceFile = "processes/ParallelGateway.bpmn";

        Deployment deployment = processManageService
                .deployByClasspathResources("购物", "ParallelGateway", null, null, processResourceFile);
    ...
    public void startProcess(){
        String processInstanceKey = "parallelGateway";
    ...
    public void completeTask(){
        String taskId = "70e7356c-a6ea-11ea-b1d2-000ec6dd34b8";
